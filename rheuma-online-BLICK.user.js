...
function gros(){
	addstyle(""+
		...
		"	font-size:/**/"+groeinst+"px/**/!important;"+
		"}"+
		...
		// "}"+
		// "blockquote.messageText h2.title {"+
		// "	font-family:/*schrift*/"+schriftreihe+"/*schrift*/;"+
		// "	font-size: /**/"+groeinst+"px/**/;"+
		// "}"+		
		"");
...
function absatz(){
	...
	addstyle("/*abs*/"+
		"blockquote.messageText {"+
			"line-height:1.5"+
		"}"+
		"blockquote.messageText li {"+
			"margin-bottom: 1em;"+
		"}"+
		"blockquote.messageText br {"+
		"	margin-bottom: 1em;"+
		"	content:' ';"+
		"	display:block;"+
		"}/*abs*/");
...
function kleinpage(){ //nicht mehr benötigt ( derzeitiges Layout benutzt flexboxen)
	// addstyle("/*kleinpage*/"+
...
function invertcolor(){
	addstyle("/*invert*/"+
	".message{"+
	"background-color:#00020A!important;"+
	"}"+
	"blockquote.messageText{"+
	...
	"}"+
	"blockquote.messageText .attribution{"+
